...
MaxSpecial = 100000
Special = MaxSpecial
Sounds = {Slash={"rbxasset://sounds//swordslash.wav",1.2,1},Shoot={"http://www.roblox.com/asset/?id=16211041",2,1},Stick={"http://www.roblox.com/asset/?id=2767090",15,1},Hit={"http://www.roblox.com/asset/?id=10209590",0.9,1},Block={"rbxasset://sounds\\metal.ogg",1.4,1}}
...
function Shoot(mouse)
	...
	Notime(function()
		repeat
			wait()
		until (powe >= MaximumPower) or shoot
		wait(6)
		if (shoot == false) then
			shoot = true
		end
	...
	repeat
		wait()
		powe = powe + 4.8
		if (powe > MaximumPower) then
			powe = MaximumPower
		end
		Bar.Size = UD(powe / MaximumPower, 0, 1, 0)
		local sped = 16 - ((powe / MaximumPower) * 9)
